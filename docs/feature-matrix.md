...
| Installed-driver diagnostic tracing | Optional | Windows | Integration | Bash | M10a1/M10a3 may qualify bounded DbgView capture for notification, branch, or shrink diagnosis; it is not an accounting or simulation gate and must not silently persist debug settings |
