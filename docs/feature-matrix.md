...
| Installed-driver diagnostic tracing | Optional | Windows | Integration | Bash | A checksum/signature-verified bounded DbgView lifecycle capture completed without resize, reboot, driver restart, boot logging, or debug-filter change; no matching informational record appeared, and M10a3 remains separately approved diagnostic work |
