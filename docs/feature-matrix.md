...
| RHEL virtio-mem controller | In Progress | Host | Service | Rust + systemd | Installed controller completed a guarded zero-to-1-GiB bootstrap on trusted development guest `win11_gpu`; M9d, M9e, and the bounded M10b recovery scope are complete, while M10e-M10g target reconciliation and qualification remain |
