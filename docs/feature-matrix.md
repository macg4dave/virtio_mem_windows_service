...
| RHEL-controlled cross-platform developer gate | Complete | Both | Ops | Bash + VS Code tasks | Latest gates pass 45 core, 48 host, and 67 native Windows tests with release builds, formatting, and warnings-as-errors Clippy |
...
| Windows automatic shrink | Qualified for trusted development deployment | Host + driver | Integration | Rust + Bash | One-block retry/recovery passed live; a paced 256 MiB ramp reclaimed about 2.93 GiB before stalling; selected service policy uses one convergence-gated 64 MiB quantum and remains default-off elsewhere |
