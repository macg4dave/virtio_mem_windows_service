...
| Windows automatic shrink | Implemented default-off; live unqualified | Host + driver | Integration | Rust + Bash | Hermetic tests prove exact-target notifications at 30/60/120 seconds within three retries and 300 seconds plus latched stall; controls remain off pending live qualification |
