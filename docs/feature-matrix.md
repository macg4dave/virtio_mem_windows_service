...
| Report freshness and bounded delivery | In Progress | Both | Contract | Rust | Version 2 identity/provenance, process-local replay rules, and partial/oversized input rejection are implemented; ACLs, restart-safe handoff, retention, and rotation remain |
